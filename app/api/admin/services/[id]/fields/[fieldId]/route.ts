...
export async function PATCH(
  ...
  const field = await prisma.serviceField.findFirst({
    where: { id: params.fieldId, serviceId: params.id },
  });
  ...
  const updated = await prisma.serviceField.update({
...
export async function DELETE(
  ...
  await prisma.serviceField.delete({ where: { id: params.fieldId } });
