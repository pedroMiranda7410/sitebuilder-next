...
export function TranslatableInput({
  ...
  function handleChange(text: string) {
    if (languages.length === 1) {
      // monolingual: keep as object for consistency
  ...
  return (
    <div className="flex flex-col gap-1.5">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  activeLang === lang
                    ? "bg-white text-neutral-900 border-b-2 border-b-white"
      ...
      <input
        ...
        className={cn(
          "h-10 w-full px-3 text-sm text-neutral-900 bg-white border border-neutral-200 focus:outline-none focus:ring-2 focus:ring-neutral-900 placeholder:text-neutral-400 transition",
